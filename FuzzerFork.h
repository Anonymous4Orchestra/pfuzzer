...
public:
  ...
  void CalculateSeedWeight(ConstraintGroup &SelectedGroup,
                           ...
                           std::string FuzzerName) {
    std::unordered_map<std::uintptr_t, double> TargetWeightMap;
    std::unordered_map<std::uintptr_t, double> NonTargetWeightMap;
    ...
    const double kNonTargetWeightMin = 1.0;
